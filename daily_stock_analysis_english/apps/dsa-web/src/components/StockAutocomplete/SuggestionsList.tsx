...
const MARKET_BADGE_CONFIG = {
  CN: { label: 'A-shares', className: 'border-danger/25 bg-danger/10 text-danger' },
  HK: { label: 'Hong Kong stocks', className: 'border-success/25 bg-success/10 text-success' },
  US: { label: 'US stocks', className: 'border-cyan/25 bg-cyan/10 text-cyan' },
  ...
  BSE: { label: 'Beijing Stock Exchange', className: 'border-orange-500/25 bg-orange-500/10 text-orange-500' },
} as const;
